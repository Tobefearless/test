...
public:
    ...
    void setupUi(QMainWindow *Historical_curve)
    {
        ...
        Historical_curve->resize(1377, 612);
        ...
        gridLayout->addWidget(chartView, 1, 0, 1, 14);

        horizontalSpacer_5 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout->addItem(horizontalSpacer_5, 0, 12, 1, 1);
        ...
        gridLayout->addWidget(time_sta, 0, 4, 1, 1);
        ...
        com_room->setMinimumSize(QSize(220, 0));
        QFont font1;
...
""));
        ...
        gridLayout->addWidget(time_end, 0, 7, 1, 1);
...
""));
        ...
        gridLayout->addWidget(com_interval, 0, 10, 1, 1);
