...
public:
    ...
    void setupUi(QMainWindow *System_Setting)
    {
        ...
        groupBox_4->setGeometry(QRect(600, 420, 221, 181));
        QFont font;
...
"}"));
        ...
        groupBox_2->setGeometry(QRect(600, 150, 501, 171));
        QFont font3;
        ...
        groupBox_3->setGeometry(QRect(600, 320, 501, 91));
...
"}"));
        ...
        groupBox_5->setGeometry(QRect(830, 420, 271, 181));
...
""));
        ...
        Modify->setGeometry(QRect(600, 610, 501, 41));
...
"}"));
        ...
        label->setGeometry(QRect(790, 10, 151, 31));
        QFont font8;
        ...
        Room_Choose->setGeometry(QRect(600, 60, 171, 31));
...
""));
        ...
        groupBox_6->setGeometry(QRect(600, 90, 501, 51));
