...
"}*/"));
        ...
        groupBox->setGeometry(QRect(350, 80, 661, 401));
        QFont font;
...
""));
        ...
        label->setGeometry(QRect(1020, 100, 81, 21));
        QFont font1;
        ...
        label_2->setGeometry(QRect(1020, 150, 81, 31));
        ...
        lineEdit_account->setGeometry(QRect(1130, 100, 211, 31));
        QFont font2;
...
"}"));
        ...
        lineEdit_passwd->setGeometry(QRect(1130, 150, 211, 31));
        QFont font3;
...
"}"));
        ...
        btn_add->setGeometry(QRect(1130, 340, 211, 41));
        QFont font4;
        ...
        btn_add->setStyleSheet(QLatin1String("QPushButton {\n"
"color: rgb(255, 255, 255);\n"
...
"}"));
        ...
        btn_remove->setGeometry(QRect(1130, 430, 211, 41));
        btn_remove->setFont(font4);
        btn_remove->setStyleSheet(QLatin1String("QPushButton {\n"
"color: rgb(255, 255, 255);\n"
" border:5px outset rgb(39,118,129);\n"
" background-color: qconicalgradient(cx:0.5, cy:0.5, angle:180, stop:0.49999 rgba(46, 138, 149, 255), stop:0.50001 rgba(55, 158, 169, 255));\n"
"border-radius:10px;\n"
