...
QT_MOC_LITERAL(1, 9, 11), // "Data_Signal"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 4) // "info"

    },
    "Mythread\0Data_Signal\0\0info"
};
...
void Mythread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Data_Signal((*reinterpret_cast< QVariant(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Mythread::*_t)(QVariant );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Mythread::Data_Signal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Mythread::Data_Signal(QVariant _t1)
{
