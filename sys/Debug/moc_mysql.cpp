...
QT_MOC_LITERAL(1, 6, 16), // "send_ChangeTable"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 15), // "send_ModeChange"
QT_MOC_LITERAL(4, 40, 11) // "finsh_table"

    },
    "mysql\0send_ChangeTable\0\0send_ModeChange\0"
    "finsh_table"
};
...
void mysql::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->send_ChangeTable(); break;
        case 1: _t->send_ModeChange(); break;
        case 2: _t->finsh_table(); break;
        default: ;
        }
        ...
        {
            typedef void (mysql::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&mysql::send_ChangeTable)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (mysql::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&mysql::send_ModeChange)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (mysql::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&mysql::finsh_table)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void mysql::send_ChangeTable()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void mysql::send_ModeChange()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void mysql::finsh_table()
{
