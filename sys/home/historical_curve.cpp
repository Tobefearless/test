...
void Historical_curve::initial_chart()
{
    ...
    m_tem_Series->setName(R"(<html><head/><body><p><span style=" font-family:'黑体'; font-size:16pt; font-weight:600; color:#ffffff;">温度t/℃</span></p></body></html>)");
    m_hum_Series->setName(R"(<html><head/><body><p><span style=" font-family:'黑体'; font-size:16pt; font-weight:600; color:#ffffff;">湿度h/%</span></p></body></html>)");
