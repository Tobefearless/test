...
/**
 * @brief User_Management::table_setting
 *              初始化表格设置
 */
...
/**
 * @brief User_Management::update_user
 *      更新用户管理到本地
 */
...
/**
 * @brief User_Management::Write_inUser
 *      读取文本里的用户
 */
...
/**
 * @brief User_Management::on_btn_add_clicked
 *      添加用户
 */
...
/**
 * @brief User_Management::on_btn_remove_clicked
 *          移除用户
 */
