...
/**
 * @brief Data_report::Get_interal
 *        get button of number
 *
 * @return the button of number
 */
...
/**
 * @brief Data_report::Report_Generation
 * @param filename  the data file name
 * @param Interval  report data Interval
 * @param some      device or sensor number
 * @param head      file text head
 */
...
/**
 * @brief Data_report::on_btn_sure_clicked
 *        button callback to deal click event
 */
...
/**
 * @brief Data_report::on_com_room_currentIndexChanged
 * @param index
 *          Test
 */
