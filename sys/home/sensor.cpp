...
/**
 * @brief Sensor::Parameter_setting
 *          参数设置，将txt文本里面的参数读取到控件上
 */
...
/**
 * @brief Sensor::on_btn_save_clicked
 *          存储按键的回调函数，用于发送和保存传感器参数
 */
...
/**
 * @brief Sensor::on_tableWidget_itemDoubleClicked
 *          判断内容是否被修改
 * @param item  表中的哪一个框
 */
