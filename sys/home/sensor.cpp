...
{
    global_data::coJust = ui->tableWidget_2->item(0,2)->text().toDouble();
    global_data::co2Just = ui->tableWidget_2->item(1,2)->text().toDouble();
    global_data::nh3Just = ui->tableWidget_2->item(2,2)->text().toDouble();
