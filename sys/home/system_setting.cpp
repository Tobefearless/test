...
/**
 * @brief System_Setting::searchPort
 *      查询电脑上的可用串口
 * @return
 */
...
/**
 * @brief System_Setting::OpenSerial
 *          打开串口
 * @param portName  端口名称
 * @param baudRate  波特率
 * @param dataBits  数据比特
...
/**
 * @brief System_Setting::show_Enable
 *      使能或禁止，窗口控件
 */
...
/**
 * @brief System_Setting::Serial_show_Enable
 *          串口控件使能
 */
...
/**
 * @brief System_Setting::Serial_show_Disable
 *          禁止窗口控件
 */
...
/**
 * @brief System_Setting::Default_parameter
 *      初始化参数
 */
void System_Setting::Default_parameter()
{
    for( uint8_t id = 0 ; id < DEV ; id++ ){
...
/**
 * @brief System_Setting::Key_States
 *          设置按钮的颜色（样式）
 * @param button    按钮
 * @param state     状态
 */
...
/**
 * @brief System_Setting::Simple_trans
 *          简短命令传输
 * @param cmd   命令 打开或是关闭
 */
...
/**
 * @brief System_Setting::Room_Ctrol_Change
 *      房间的控制模式改变
 * @param room  房间
 */
...
/**
 * @brief System_Setting::GetRadio_Status
 *          获取房间的状态，用于模式的改变
 * @return  房间的状态
 */
...
/**
 * @brief System_Setting::Diff_Save
 *      存储房间的配置参数
 * @param room  房间号
 */
...
/**
 * @brief System_Setting::Device_Change
 *      用于改变房间的模式
 * @param room  房间号
 * @param way   模式
 * @return
...
/**
 * @brief System_Setting::Message_alert
 * @param title 提示标题
 * @param text  提示内容
 * @param hint  提示框图标
 */
...
/**
 * @brief System_Setting::on_Modify_clicked
 *      保存按钮
 */
...
/**
 * @brief System_Setting::on_btn_connect_clicked
 *      串口链接按钮回调函数
 */
...
/**
 * @brief System_Setting::on_btn_Wconnect_clicked
 *      wifi按钮回调函数，用于wifi 账号与密码的发送
 */
...
/**
 * @brief System_Setting::on_Heat_Learn_clicked
 *      按钮状态变化，用于通知下位机进行红外学习
 */
...
/**
 * @brief System_Setting::on_Room_Choose_currentIndexChanged
 *          设置房间发生改变
 * @param index 房间
 */
...
/**
 * @brief System_Setting::on_comboBox_wifi_currentIndexChanged
 *      wifi 4G切换
 * @param index wifi序号
 *
 */
...
/**
 * @brief System_Setting::on_btn_scan_clicked
 *      扫描串口按键
 */
