...
char global_data::id[DEV][20] = {"SCGX230413001"};
...
double global_data::coJust  = 0;
double global_data::co2Just = 0;
double global_data::so2Just = 0;
double global_data::nh3Just = 0;
