...
#define FILENAME "C:/Windows/SXZC220808"      //系统配置参数文件路径
#define RecordFILE "C:/Windows/Historical_data_sheet"       //文件记录路径

#define NH3Calculator(MQ_X) (410.74*MQ_X*MQ_X*MQ_X*MQ_X*MQ_X-2718.5*MQ_X*MQ_X*MQ_X*MQ_X+7015.6*MQ_X*MQ_X*MQ_X-8747.9*MQ_X*MQ_X+5271.7*MQ_X-1228.7)
#pragma pack(push)
#pragma pack(1)
...
public:
    ...
    static SENSOR_JUST_TYPE sensor_just_data[DEV];
};
