...
#define FILENAME "C:/Windows/ALL1"
...
/*
    主页箭头图标位置
*/
#define MAIN_RIGHT_ARROW    ":/img/right_arrow.png"
#define MAIN_DOWN_ARROW     ":/img/down_arrow.png"
...
typedef struct{
    ...
    bool isChartWiedet;
    bool isDataPWiedet;
    bool isSensorPWiedet;
    bool isCommunicationWiedet;
    bool isUserWiedet;
    bool isHelpWiedet;
    bool isQuitWiedet;
}IS_WIDGET_TYPE;
